...
public class LoginActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sm = StiSysManagerFactory.getInstance(this.getApplicationContext());
	...
	public void sendLogin(View view) {
		...
		setError("..Login..bitte warten..");// kein fehler aber textausgabe f�r
											// warten
		errorText();
	...
	public void sendRegistration(View view) {
		EditText account_password = (EditText) findViewById(R.id.account_password);
		String a_password = account_password.getText().toString();
		setError("..Registration..bitte warten..");// kein fehler aber
													// textausgabe f�r warten
		errorText();
	...
	/**
	 * Sobald Login erfolgreich war, wird die Activity auf ChatActivity
	 * gewechselt. Aufruf beim Chat.java
	 */
